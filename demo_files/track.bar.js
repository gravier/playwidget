...
addBar = function (pos, comment, isTemp) {
  ...
  $(".jp-play-bar1").append(
    "<div class='mark " + tempClass + "' style='left: " + pos + "%'>" + "<span>" + comment + "</span>" + "</div>");
...
render = function () {
  ...
  $.each(fileMarks, function (ind, mark) {
    addBar(mark.position, mark.comment, false);
  });
}
